...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, c, q) {
        ...
        if ("function" == typeof p) {
            b = p.call(b);
            for (var u = 0; !(p = b.next()).done;) f.push(c.call(q, p.value, u++))
        } else
            for (p = b.length, u = 0; u < p; u++) f.push(c.call(q, b[u], u));
        return f
    }
}, "es6", "es3");
...
(function() {
    function b(a, g) {
        var b = Array.from(a.querySelectorAll(g));
        a.matches && a.matches(g) && b.splice(0, 0, a);
        return b
    }
    ...
    function y(a) {
        ...
        null === a.getAttribute("id") && (b = a.classList.value.match(/cid-.*?(?=\s|$)/) + "-carousel");
    ...
    function F(a) {
        ...
        a.querySelectorAll(".carousel-item").forEach(function(a) {
            for (var b = a, g = 1; g < d; g++) {
                (b = b.nextElementSibling) || (b = a.parentNode.children[0] === a ? a.nextElementSibling : a.parentNode.children[0]);
                var k;
                if (k = b) {
                    var c = 0;
    ...
    function z(a, b, d) {
        ...
        h.contains("row") &&
            (h.remove("row"), h.add("media-container-row"));
        ...
        a.setAttribute("data-pie", "{ " + G(a.closest("section")) + ' "percent": ' + d + ', "size": 150, "colorCircle": "#f1f1f1", "stroke": 5, "colorSlice": "url(#' + b + ')", "fontSize": "1.3rem", "number": false }');
    ...
    var e, n, t = "function" == typeof jQuery;
    t && (e = jQuery);
    e ? n = e("html").hasClass("is-builder") : n = document.querySelector("html").classList.contains("is-builder");
    ...
    Element.prototype.footerReveal = function() {
        function a() {
            !d && this.offsetHeight <= window.outerHeight ?
                (this.style.zIndex = "-999", this.style.position = "fixed", this.style.bottom = "0", this.style.width = b.offsetWidth, b.style.marginBottom = this.offsetHeight) : (this.style.zIndex = "", this.style.position = "", this.style.bottom = "", this.style.width = "", b.style.marginBottom = "")
        }
    ...
    var I = function() {
        ...
        var d = parseInt(window.innerHeight / 2, 10),
            c = parseInt((window.getComputedStyle ?
                getComputedStyle(a, null) : a.currentStyle).height, 10);
        b.removeChild(a);
        return c == d
    }();
    l(function() {
                    ...
                    if (d && (/youtu\.?be/g.test(d[3]) || /vimeo/g.test(d[3])))
                        if (d && /youtu\.?be/g.test(d[3])) {
                            ...
                            h.onload = function() {
                                if (120 === (h.naturalWidth || h.width)) {
                                    ...
                                    switch (b) {
                                        ...
                                        case "sddefault.jpg":
                                            ...
                                            break;
                                        default:
                                            n && (c.style.backgroundImage = 'url("images/no-video.jpg")', c.style.display = "block")
                                    }
                                ...
                                k.classList.add("mbr-video-foreground");
                                k.appendChild(b);
                                g.appendChild(k);
                                m.appendChild(g);
                                b.classList.add("mbr-background-video");
                                a.childNodes[1].before(m);
                                var e = h.naturalHeight,
                                    x = h.naturalWidth,
                                    f = h.naturalHeight / h.naturalWidth,
                                    E = b.parentNode.clientHeight,
                                    r = b.parentNode.clientWidth;
                                e = e < E ? e : E;
                                x = x > r ? x : r;
                                e / x != f && (e = x * f);
                                f = new YouTubePlayer(b, {
                                    height: e,
                                    width: x,
                                    modestbranding: !0,
                                    autoplay: !0,
                            ...
                            if (d && /vimeo/g.test(d[3])) {
                                ...
                                m.open("GET", "https://vimeo.com/api/v2/video/" + d[6] + ".json", !0);
                                m.onreadystatechange = function() {
                                    if (4 === this.readyState)
                                        ...
                                        } else n && (c.style.backgroundImage = 'url("images/no-video.jpg")', c.style.display = "block")
                                };
                                m.send();
                                m = null;
                                a.querySelector(".mbr-background-video") && a.querySelector(".mbr-background-video").remove();
                                m = document.createElement("div");
                                m.classList.add("mbr-background-video");
                                a.childNodes[1].before(m);
                                b = new Vimeo.Player(m, {
                                    id: b,
                                    loop: !0,
                                    background: !0,
                                    responsive: !0,
                                ...
                                m = b.element.parentNode;
                                m.style.overflow = "hidden";
                                b.element.style.pointerEvents =
                                    "none";
                                b.element.style.marginLeft = "-" + (b.element.scrollWidth - m.scrollWidth) / 2 + "px";
                                b.element.style.minHeight = "100vh";
                                b.element.style.minWidth = "177.77vh"
                            }
                        }
                    else n && (c.style.backgroundImage = 'url("images/video-placeholder.jpg")', c.style.display = "block")
                }
            })
        }
        ...
        if (t) e(document).on("add.cards delete.cards", function(a) {
            k && clearTimeout(k);
        ...
        if (t) e(document).on("add.cards", function(a) {
        ...
        if (n) e(document).on("changeParameter.cards", function(a, b, c, h) {
            if ("bg" === b) switch (h) {
                case "type":
    ...
    if (!n) {
        ...
        if (t && e.fn.socialLikes) e(document).on("add.cards", function(a) {
                ...
                var a = function() {
                        ...
                        c.forEach(function(c) {
                            var h = c.offsetHeight,
                                e = d(c);
                            (e + h >= a && e - 50 <= g || b(c)) && c.classList.contains("hidden") && (c.classList.remove("hidden"), c.classList.add("animate__fadeInUp"),
    ...
    l(function() {
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            ...
            window.addEventListener("scroll", function() {
                window.scrollY > window.innerHeight ? u(a) : p(a)
            });
    ...
    if (!n && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) e(document).on("add.cards", function(a) {
        var b = a.target;
    ...
    if (!n) {
        ...
        var A = document.querySelectorAll(".dropdown-menu.show");
        ...
        !w() && (v = document.querySelector("section.menu")) &&
            (A = window.innerWidth, !v.querySelector(".navbar").classList.contains("collapsed") && 991 < A && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
    ...
    n || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) {
    ...
    if (n) e(document).on("add.cards changeParameter.cards", function(a, b) {
    ...
    if (n && t) e(document).on("add.cards", function(a) {
        e(a.target).hasClass("testimonials-slider") && y(a.target)
    }).on("changeParameter.cards", function(a, b, c) {
        "testimonialsSlides" === b && 0 == e(a.target).find(".carousel-item.active").length && B(a.target)
    });
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.in">Mobirise HTML Web Creator</a> Mobirise v5.6.0';
